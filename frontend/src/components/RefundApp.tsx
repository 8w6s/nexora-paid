  ...
  return (
    <>
      ...
      >
        ...
        >
          {t("storefront.legal.refundTitle")}
        </h1>
        <div className="info-content" style={{ lineHeight: "1.7", color: "var(--ink-soft)" }}>
          ...
          <p>
            Due to the nature of digital goods (instant delivery of license keys and serial codes),
            all sales on Nexora are final. Once a key or code is generated and displayed on-scren or
            delivered to your email address, we cannot issue a refund, exchange, or store credit.
          </p>
          ...
          <ul>
            <li>
              The delivered key is proven to be invalid, expired, or already used before the time of
              purchase.
            </li>
            <li>
          ...
          <p>
            ...
            >
              {t("storefront.legal.supportLink")}
            </span>{" "}
            section. Include your Order ID and screenshots showing the error. We will investigate
