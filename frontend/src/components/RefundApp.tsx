      ...
      >
        ...
        <div className="info-content" style={{ lineHeight: "1.7", color: "var(--ink-soft)" }}>
          ...
          <p>
            ...
            codes), all sales on Nexora are final. Once a key or code is generated and
            displayed on-scren or delivered to your email address, we cannot issue a refund,
            exchange, or store credit.
          </p>

          <h2>2. Exceptions</h2>
          <p>
            We may offer refunds or key replacements under the following strict conditions:
          </p>
          <ul>
            <li>
            ...
            <li>
              Your payment was confirmed but the system failed to deliver any keys due to
              stock exhaustion.
            </li>
          </ul>
          ...
          <p>
            If you encounter an issue with your purchase, please open a support ticket under
            the{" "}
            <span
