...
const TEMPLATES = [
  ...
  },
  {
    ...
    icon: "box",
    title: "Accounts",
    desc: "Streaming, gaming, premium accounts",
  },
  {
    key: "Game",
    icon: "bolt",
    title: "Discord Nitro",
    desc: "Nitro gift links, Nitro Basic, boost codes",
  },
  {
    key: "Game",
    icon: "zap",
  ...
  },
  {
    ...
    desc: "Blank template — pick your own category & settings",
  },
];
      ...
      <div className="pw-step" key={step} ref={stepRef}>
        {step === 1 && (
          <>
            ...
            <p className="pw-sub">
              Pick a template to start. It just preselects a category — you can change everything.
            </p>
