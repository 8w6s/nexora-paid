...
const BrandIcon: React.FC<{ id: string; size?: number }> = ({ id, size = 28 }) => {
  ...
  if (id === "crypto_eth") {
    return (
      <svg width={size} height={size} viewBox="0 0 512 512" fill="none">
        <path d="M 76.8 0 L 435.2 0 C 477.587 0 512 34.413 512 76.8 L 512 435.2 C 512 477.587 477.587 512 435.2 512 L 76.8 512 C 34.413 512 0 477.587 0 435.2 L 0 76.8 C 0 34.413 34.413 0 76.8 0 Z" fill="#627EEA"/>
        <path d="M 255.981 81 L 253.633 88.976 L 253.633 320.394 L 255.981 322.737 L 363.402 259.24 L 255.981 81 Z" fill="#C1CCF8"/>
        <path d="M 255.955 81 L 148.533 259.24 L 255.955 322.737 L 255.955 210.413 L 255.955 81 Z" fill="#FFFFFF"/>
        <path d="M 255.983 343.088 L 254.659 344.702 L 254.659 427.137 L 255.983 431 L 363.467 279.625 L 255.983 343.088 Z" fill="#C1CCF8"/>
        <path d="M 255.955 431 L 255.955 343.088 L 148.533 279.625 L 255.955 431 Z" fill="#FFFFFF"/>
        <path d="M 256.026 322.735 L 363.445 259.239 L 256.026 210.411 L 256.026 322.735 Z" fill="#8197EE"/>
      </svg>
    );
  }
  if (id === "crypto_sol") {
      ...
      <svg width={size} height={size} viewBox="0 0 512 512" fill="none">
        ...
        <g clipPath="url(#_clipPath_mYAZQYB0OspfKnvspMbmwj6tQ4mQt5hb)">
          ...
          <g clipPath="url(#_clipPath_e6AhEm7wqeFcqgyblWmuKS4A7JRMw698)">
            <g>
              <path d=" M 76.8 0 L 435.2 0 C 477.587 0 512 34.413 512 76.8 L 512 435.2 C 512 477.587 477.587 512 435.2 512 L 76.8 512 C 34.413 512 0 477.587 0 435.2 L 0 76.8 C 0 34.413 34.413 0 76.8 0 Z " fill="#1E1E1E"/>
              <g>
                <linearGradient id="_lgradient_0" x1="0.00003" y1="14.894" x2="1.0256" y2="14.8847" gradientTransform="matrix(350,0,0,65.748,81,123.123)" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopOpacity="1" stopColor="rgb(89,157,176)"/>
                  <stop offset="100%" stopOpacity="1" stopColor="rgb(71,248,195)"/>
                </linearGradient>
                <path d=" M 380.717 185.701 C 378.533 187.704 375.688 188.832 372.725 188.871 L 92.27 188.871 C 82.314 188.871 77.297 177.494 84.181 170.824 L 130.249 126.409 C 132.389 124.336 135.242 123.16 138.222 123.123 L 419.746 123.123 C 429.799 123.123 434.719 134.596 427.719 141.305 L 380.717 185.701 Z " fill="url(#_lgradient_0)"/>
                <linearGradient id="_lgradient_1" x1="0.00003" y1="-2.0059" x2="1.019" y2="-2.0138" gradientTransform="matrix(350,0,0,65.651,81,342.01)" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopOpacity="1" stopColor="rgb(196,79,226)"/>
                  <stop offset="100%" stopOpacity="1" stopColor="rgb(115,176,208)"/>
                </linearGradient>
                <path d=" M 380.717 404.588 C 378.519 406.556 375.675 407.649 372.725 407.661 L 92.27 407.661 C 82.314 407.661 77.297 396.382 84.181 389.712 L 130.249 345.18 C 132.408 343.149 135.258 342.016 138.222 342.01 L 419.746 342.01 C 429.799 342.01 434.719 353.405 427.719 360.056 L 380.717 404.588 Z " fill="url(#_lgradient_1)"/>
                <linearGradient id="_lgradient_2" x1="0.0575" y1="0.5" x2="0.9613" y2="0.5" gradientTransform="matrix(350,0,0,65.651,81,232.625)" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopOpacity="1" stopColor="rgb(119,140,191)"/>
                  <stop offset="100%" stopOpacity="1" stopColor="rgb(93,205,201)"/>
                </linearGradient>
                <path d=" M 380.717 235.697 C 378.519 233.73 375.675 232.636 372.725 232.625 L 92.27 232.625 C 82.314 232.625 77.297 243.903 84.181 250.574 L 130.249 295.106 C 132.408 297.108 135.247 298.217 138.222 298.275 L 419.746 298.275 C 429.799 298.275 434.719 286.88 427.719 280.229 L 380.717 235.697 Z " fill="url(#_lgradient_2)"/>
              </g>
            </g>
          </g>
        </g>
  ...
  if (id === "stripe") {
    return (
      <svg width={size} height={size} viewBox="0 0 512 512" fill="none">
        <path d="M 76.8 0 L 435.2 0 C 477.587 0 512 34.413 512 76.8 L 512 435.2 C 512 477.587 477.587 512 435.2 512 L 76.8 512 C 34.413 512 0 477.587 0 435.2 L 0 76.8 C 0 34.413 34.413 0 76.8 0 Z" fill="#635BFF"/>
        <path d="M 231.036 184.786 C 231.036 169.692 243.421 163.886 263.934 163.886 C 293.349 163.886 330.504 172.788 359.918 188.656 L 359.918 97.704 C 327.795 84.931 296.058 79.9 263.934 79.9 C 185.366 79.9 133.117 120.925 133.117 189.43 C 133.117 296.251 280.19 279.222 280.19 325.279 C 280.19 343.082 264.708 348.888 243.034 348.888 C 210.911 348.888 169.885 335.729 137.374 317.925 L 137.374 410.039 C 173.368 425.52 209.75 432.1 243.034 432.1 C 323.537 432.1 378.883 392.236 378.883 322.957 C 378.496 207.621 231.036 228.134 231.036 184.786 Z" fillRule="evenodd" fill="#FFFFFF"/>
      </svg>
    );
  }
  if (id === "paypal") {
    return (
      <svg width={size} height={size} viewBox="0 0 512 512" fill="none">
        <path d="M 76.8 0 L 435.2 0 C 477.587 0 512 34.413 512 76.8 L 512 435.2 C 512 477.587 477.587 512 435.2 512 L 76.8 512 C 34.413 512 0 477.587 0 435.2 L 0 76.8 C 0 34.413 34.413 0 76.8 0 Z" fill="#FFFFFF"/>
        <path d="M 224.538 149.206 C 219.49 149.205 215.192 152.877 214.404 157.864 L 197.561 264.664 L 182.085 362.8 L 182.076 362.882 L 182.095 362.8 L 197.57 264.664 C 198.357 259.676 202.651 256.006 207.699 256.006 L 257.042 256.006 C 306.7 256.006 348.849 219.776 356.546 170.681 C 357.133 166.951 357.447 163.257 357.518 159.611 L 357.518 159.605 L 357.512 159.605 C 344.892 152.984 330.073 149.206 313.835 149.206 L 224.538 149.206 Z" fill="#001C64"/>
        <path d="M 357.514 159.607 C 357.445 163.253 357.127 166.951 356.542 170.681 C 348.845 219.776 306.697 256.006 257.038 256.006 L 207.695 256.006 C 202.647 256.006 198.353 259.676 197.566 264.664 L 182.091 362.8 L 172.379 424.37 C 172.001 426.777 172.694 429.229 174.277 431.081 C 175.86 432.933 178.175 434 180.611 434 L 234.17 434 C 239.218 434 243.516 430.328 244.304 425.342 L 258.413 335.864 C 259.204 330.876 263.5 327.2 268.548 327.2 L 300.085 327.2 C 349.744 327.2 391.886 290.972 399.584 241.881 C 405.048 207.031 387.511 175.327 357.516 159.607 L 357.514 159.607 Z" fill="#0070E0"/>
        <path d="M 163.687 78 C 158.638 78 154.339 81.675 153.553 86.664 L 111.526 353.165 C 111.146 355.572 111.839 358.026 113.422 359.879 C 115.005 361.733 117.321 362.8 119.758 362.8 L 182.084 362.8 L 197.559 264.664 L 214.402 157.864 C 215.19 152.877 219.488 149.205 224.536 149.206 L 313.83 149.206 C 330.071 149.206 344.891 152.99 357.512 159.602 C 358.372 114.906 321.492 78 270.779 78 L 163.687 78 Z" fill="#003087"/>
      </svg>
    );
  }
  return (
      ...
      <div className="pay-group-section">
        ...
        <div className="pay-grid-layout">
          {providers.map((p) => {
            ...
            return (
              <div key={p.id} className={`pay-method-card ${p.enabled ? "on" : ""} ${isExpanded ? "expanded" : ""}`}>
                <div className="pay-method-main">
                  <div className="pay-method-left">
                    ...
                    <div className="pay-method-info">
                      ...
                      {!served && <span className="pay-method-warning">Not available in selected country ({country})</span>}
                    </div>
                  </div>
