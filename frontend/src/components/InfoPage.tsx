...
export const InfoPage: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
  <ConfigProvider>
    <ToastProvider>
      <AuthProvider>
        <CartProvider>
          ...
          <main className="container info-page" style={{ padding: "40px 20px", maxWidth: "800px", margin: "0 auto" }}>
            <h1 style={{ fontSize: "2rem", marginBottom: "24px", fontWeight: 700, color: "var(--ink)" }}>{title}</h1>
