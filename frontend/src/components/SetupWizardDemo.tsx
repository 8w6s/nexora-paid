...
export const SetupWizardDemo: React.FC = () => {
  ...
  const [_storeName, _setStoreName] = useState("Nexora Store");
  ...
  return (
    <main className="su">
      <AnimatedBackground />
      <div className="su-demo-banner">
        <Icon name="zap" size={12} />
        <span>Demo mode — no backend, nothing saved</span>
      </div>
        ...
        <div className="su-step" key={step} ref={stepRef}>
          ...
          {step === 2 && (
            <>
              ...
              <p className="su-subhead">
                Configure how your storefront presents itself. You can customize descriptions, theme
...
const Styles: React.FC = () => (
  <style>{`
    ...
    .su-demo-banner { position: fixed; top: 16px; left: 50%; transform: translateX(-50%); z-index: 50; display: inline-flex; align-items: center; gap: 8px; padding: 7px 14px; border-radius: 100px; background: rgba(251, 191, 36, 0.14); border: 1px solid rgba(251, 191, 36, 0.35); color: #fde68a; font-size: 0.74rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; backdrop-filter: blur(12px); }
    ...
    @media (max-width: 600px) {
      ...
      .su-demo-banner { top: 8px; font-size: 0.68rem; padding: 6px 12px; }
    }
  `}</style>
);
